...
class User_log():
    ...
    def user_record(self):
        ...
        file_check = open("/home/start/bot/logs/users/users.txt","r",encoding='utf-8')
        ...
        for line in lines:
            ...
            if line == str(self.id) + " | " + str(self.fname) + " | " + str(self.lname) + " | " + str(self.nickname):
                ...
                break
        if mark == 0:
            file_upd = open("/home/start/bot/logs/users/users.txt","a+",encoding='utf-8')
    ...
    def chat_record(self,msg):
        ...
        file_upd = open("/home/start/bot/logs/chats/" + str(self.id) + ".txt","a+",encoding='utf-8')
    ...
    def err_record(self,ex):
        #записываем ошибки
        file_upd = open("/home/start/bot/logs/err/err.txt","a+",encoding='utf-8')
        date = str(datetime.now()).split(".")[0]
